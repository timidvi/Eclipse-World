/datum/species/mothmen
	...
	blurb = "Lazarus Foundation experiment gone terribly wrong! Insects the size of a man! Who are they? Where did they come from? \
	Why didn't they write anything marginally better for a species description?!"